...
<div class="container mt-5">
	<div class="card card-body border-info col-6 mx-auto" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);margin-top:10%;">
		<form class="needs-validation" novalidate action="<?= base_url('Register/proses') ?>" method="post">
			<h4 class="text-center">Buat Akun Praktikum<br>Pemrograman Web</h4>
			<br>
			<div class="form-group">
				...
				<div class="row my-3">
					<div class="col-md-12">
						<input type="password" name="konfirm_password" class="form-control" placeholder="konfirmasi password" required>
					</div>
				</div>
